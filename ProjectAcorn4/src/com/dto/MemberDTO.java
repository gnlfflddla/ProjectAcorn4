...
public class MemberDTO {
	...
	public MemberDTO(String userid, String passwd, String username, String post, String addr1, String addr2,
			String phone1, String phone2, String phone3, String email1, String email2, String gradeno, int mileage) {
		super();
		this.userid = userid;
		this.passwd = passwd;
		this.username = username;
	...
	public String toString() {
		return "MemberDTO [userid=" + userid + ", passwd=" + passwd + ", username=" + username + ", post=" + post
				...
				+ phone3 + ", email1=" + email1 + ", email2=" + email2 + ", gradeno=" + gradeno + ", mileage=" + mileage
				+ "]";
	}
