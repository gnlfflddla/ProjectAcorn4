...
public class SendMailServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    String from = "swih0910@naver.com"; //보내는 메일
	    ...
	    if(passwd==null) {
	    	...
	    	content=username+"님의 아이디는"+userid+"입니다.";
	    	nextPage="mail/sendmail_id_completedForm.jsp";
	    }else {
	    	content=username+"님의 아이디"+userid+"의 임시비밀번호는"+passwd+"입니다.";
	    	nextPage="mail/sendmail_pw_completedForm.jsp";
	    }
